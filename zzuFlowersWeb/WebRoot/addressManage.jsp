<%-- 
    Document   : addressManage
    Created on : 2015-5-20, 17:17:40
...
<script type="text/javascript">
  function goDel()
  {
	  form1.action="addressDelete";
	  form1.submit();
  }
  
  function show(){
          form1.action="addressFind";
	  document.getElementById("xx").style.display="block";
  }
  
  function show1(){
          form1.action="addressAdd";
...
<div id="xx" class="xxx" align="left">
	<table>
		...
		<tr>
			...
			<td>简介</td>
			<td><input type="textarea" rows="3" name="P_summary"id="P_summary"/></td>
			
		</tr>
                <tr>
		
			<td>特征</td>
			<td><input type="textarea" rows="3"name="P_feature"id="P_feature"/></td>
			
		</tr>
                <tr>
		
			<td>分布</td>
			<td><input type="textarea" rows="3"name="P_distribution"id="P_distribution"/></td>
			
		</tr>
                <tr>
		
			<td>价值</td>
			<td><input type="textarea" rows="5"name="P_value"id="P_value"/></td>
			
		</tr>
                <tr>
		
			<td>文化</td>
			<td><input type="textarea" rows="5"name="P_culture"id="P_culture"/></td>
