<%-- 
    ...
    Created on : 2013-12-10, 12:56:53
...
<html>
	...
	<dl class="lanmu-list">
        ...
        <dd><a href='../admin/warelook1.jsp' title="查询物品">查询物品</a></dd>
        <dd><a href='../admin/formlook_out1.jsp' title="查看出库单">查看出库单</a></dd>
        <dd><a href='../admin/formlook_in1.jsp' title="查看入库单">查看入库单</a></dd>
        <dd><a href='../admin/warefind1.jsp' title="查找商品">查找商品</a></dd>
