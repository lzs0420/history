<%-- 
    Document   : sidebar2
    Created on : 2013-12-10, 12:53:11
...
<html>
	...
	<dl class="lanmu-list">
        ...
        <dd><a href='../public/ware_look.jsp' title="查询物品">查询物品</a></dd>
        <dd><a href='../buyer/formlook_in.jsp' title="查看入库单">查看入库单</a></dd>
        <dd><a href='../buyer/forminsert_in.jsp' title="新增入库单">新增入库单</a></dd>
        <dd><a href='../public/warefind.jsp' title="查找商品">查找商品</a></dd>
