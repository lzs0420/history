<%-- 
    Document   : warefind_single_query
    Created on : 2013-12-11, 12:31:16
...
<html>
    <head>
        ...
        <jsp:useBean id="warefind_single_query" scope="session" class="com.jsp.ware" />
    ...
    <body>
        ...
        <%
            ...
            warefind_single_query.getConn("warehouse_m", "root", "123456");
            ResultSet rs=warefind_single_query.executeQuery1(sql);
        %>
    ...
    %>
	 ...
	 <%   }if(rs!=null) rs.close();
	    warefind_single_query.closeStmt();
	    warefind_single_query.closeConn();
    %>
</table><jsp:include page="footer.jsp"></jsp:include>
    </body>
</html>
