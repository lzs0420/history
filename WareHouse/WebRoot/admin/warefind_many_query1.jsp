<%-- 
    Document   : warefind_many_query1
    Created on : 2013-12-14, 16:01:45
...
<html>
    <head>
        ...
        <jsp:useBean id="warefind_many_query1" scope="session" class="com.jsp.ware" />
    ...
    <body>
        ...
        <%
           ...
           System.out.println(sql);
            ...
            System.out.println(sql);
            warefind_many_query1.getConn("warehouse_m", "root", "123456");
            ResultSet rs=warefind_many_query1.executeQuery1(sql);
        %>
    ...
    %>
      ...
      <%
           ...
           <tr><td colspan="14" align="center" height=38px>没有符合条件的商品。</td></tr>
         <%   }
	    if(rs!=null) rs.close();
	    warefind_many_query1.closeStmt();
	    warefind_many_query1.closeConn();
    %>
    <tr height="50px">
