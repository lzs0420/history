package own.crazyit12.chapter11;
import java.awt.*;
...
public class TestTableCellEditor
{
	...
	public void init()
	{
		...
		ExtendedTableModel1 model = new ExtendedTableModel1(columnTitle , tableData);
...
class ExtendedTableModel1 extends DefaultTableModel
{
	//重新提供一个构造器，该构造器的实现委托给DefaultTableModel父类
	public ExtendedTableModel1(String[] columnNames , Object[][] cells)
	{
